...
const BackgroundButton = ({
  ...
  <button
    ...
    type={type}
    className={twMerge(
      `text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 disabled:bg-gray-500`,
      className
    )}
  >
    {children}
