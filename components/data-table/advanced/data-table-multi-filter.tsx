...
import type { DataTableFilterOption, NestedKeys } from '@/types/data-table'
import {
  RxCopy,
  RxDotsHorizontal,
  RxTextAlignCenter,
...
import { dataTableConfig, type DataTableConfig } from '@/lib/data-table'
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <RxTextAlignCenter className="mr-2 size-3" aria-hidden="true" />
          {options.length} rule
        </Button>
      </PopoverTrigger>
    ...
    <div className="flex items-center space-x-2">
          ...
          setSelectedOptions((prev) =>
            prev.map((item) => {
              if (item.id === option.id) {
                return {
                  ...item,
                  value: value as NestedKeys<TData>,
                }
              }
              return item
            }),
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          >
            <RxCopy className="mr-2 size-4" aria-hidden="true" />
            Duplicate
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
