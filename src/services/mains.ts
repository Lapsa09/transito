...
export const getTurnos = async ():Promise<ITurnos[]> => await getEnums<ITurnos[]>('turnos')

export const getResolucion = async ():Promise<IResolucion[]> =>
  await getEnums<IResolucion[]>('resolucion')

export const getLicencias = async ():Promise<ILicencias[]> => await getter<ILicencias[]>('/licencias')

export const getZonasVL = async ():Promise<IZona[]> => await getter<IZona[]>('/zonas/vl')

export const getAllZonas = async ():Promise<IBarrio[]> => await getter<IBarrio[]>('/zonas')

export const getSeguridad = async ():Promise<ISeguridad[]> =>
  await getEnums<ISeguridad[]>('seguridad')

export const getMotivos = async ():Promise<IMotivos[]> => await getter<IMotivos[]>('/motivos')
